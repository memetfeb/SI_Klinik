                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title"> Update Pembayaran
                                                                {{$trans->nama_pasien}}
                                                            </h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form role="form"
                                                                action="{{ route('transaksi.update_pembayaran', $trans->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="form-group col-md-12 col-sm-12">
                                                                    <label
                                                                        class="col-form-label col-md-6 col-sm-6 label-align">Jumlah
                                                                        Tagihan (Rp.) : </label>
                                                                    <div class="col-md-6 col-sm-6 ">
                                                                        <input class="form-control" type="text"
                                                                            name="nama_wilayah"
                                                                            placeholder="Nama Wilayah" readonly
                                                                            value="{{$trans->total_biaya}}" />
                                                                    </div>
                                                                </div>
                                                        </div>
                                                        <br>
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success">Tagihan
                                                                Lunas</button>
                                                        </div>
                                                        </form>
                                                    </div>
