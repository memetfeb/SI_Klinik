        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Pegawai</h2>
                        <div class="float-right"><a href="{{ route('pegawai.create') }}" class="btn btn-success btn"> + Tambah Pegawai </a></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="row">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="nav">
                                                        <a href="{{ route('pegawai.show', $peg->id) }}" class="btn btn-primary btn-sm">Detail</a>
                                                        <a href="#" data-toggle="modal" data-target="#delete{{$peg->id}}" class="btn btn-danger btn-sm">Delete</a>
                                                    </ul>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title"> Edit Pegawai {{$peg->nama}}
                                                            </h4>
