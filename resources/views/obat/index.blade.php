                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="float-right">
                            <a href="#" data-toggle="modal" data-target="#tambah" class="btn btn-success btn"> + Tambah Obat </a></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <div class="row">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="nav">
                                                        <a href="#" data-toggle="modal" data-target="#edit{{$ob->id}}" class="btn btn-primary btn-sm">Edit</a>
                                                        <a href="#" data-toggle="modal" data-target="#delete{{$ob->id}}" class="btn btn-danger btn-sm">Delete</a>
                                                    </ul>
                                                </td>
                                            </tr>

                                            <!-- Edit Modal -->
                                            <div class="modal fade" id="edit{{$ob->id}}" role="dialog">
                                                <div class="modal-dialog">
                                                    <!-- Modal content-->
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title"> Edit Obat {{$ob->nama_obat}}
                                                            </h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form role="form"
                                                                action="{{ route('obat.update', $ob->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PUT')
                                            ...
                                            <!-- Delete Modal -->
                                            <div class="modal fade" id="delete{{$ob->id}}" role="dialog">
                                                <div class="modal-dialog">
                                                    <!-- Modal content-->
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-footer">
                                                          <form role="form"
                                                                action="{{ route('obat.destroy', $ob->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{ route('obat.store') }}" method="POST">
                    @csrf
                    <div class="form-group col-md-12 col-sm-12">
                        <label class="col-form-label col-md-4 col-sm-4 label-align">Nama Obat : </label>
